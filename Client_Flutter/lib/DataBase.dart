    ...
    try {
      final response = await http.post(
        ...
        body: jsonEncode(<String, String>{
          ...
          /*
          'FIO': dataBaseData.filters.controllerFIO,
          'Corporation': dataBaseData.filters.controllerCorporation,
          'Department': dataBaseData.filters.controllerDepartament,
          'Phone': dataBaseData.filters.controllerPhone,
          'TypePhone': dataBaseData.filters.controllerTypePhone,
           */
        }),
      );
